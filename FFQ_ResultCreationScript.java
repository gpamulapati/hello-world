...
/**
 * FFQ_ResultCreationScript --- Class for generating result file
 * 
 * @author csc
 */

public class FFQ_ResultCreationScript {

	public static final String DATE_FORMAT_NOW = "yyyy-MM-dd-hh.mm.ss";
	FFQ_UtilitiesScript utils = new FFQ_UtilitiesScript();
	...
	public static String now() {
		...
		// "/Users/testlab-imac/Documents/workspace/iPhoneTest//FFQ_Results_Files/screenshot/";
		String strScreenshotPath = strAbsolutePath + FFQ_GlobalVariables.fResultPath+FFQ_GlobalVariables.fscreenShot+"/";
	...
	public void takeScreenshot(String strScenarioName, String strTestCaseName,
		...
		try {
			...
			// String strConfigFileName =
			// "/Users/testlab-imac/Documents/workspace/iPhoneTest/src/com/csc/results/screenshot/";
			if (isScreenshot) {
				now();
				Random rand = new Random();
				int num = rand.nextInt(1000);
